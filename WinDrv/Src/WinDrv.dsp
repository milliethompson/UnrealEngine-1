...
# ADD CPP /nologo /Zp4 /MD /W4 /WX /vd0 /GX /O2 /I "..\..\Window\Inc" /I "." /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /Yu"WinDrvPrivate.h" /FD /Zm256 /c
...
# ADD LINK32 ..\..\Window\Lib\Window.lib ..\..\Core\Lib\Core.lib ..\..\Engine\Lib\Engine.lib ..\Lib\ddraw.lib ..\Lib\dxguid.lib gdi32.lib kernel32.lib user32.lib winmm.lib /nologo /base:"0x10A00000" /subsystem:windows /dll /incremental:yes /machine:I386 /out:"..\..\System\WinDrv.dll"
...
# ADD CPP /nologo /Zp4 /MDd /W4 /WX /Gm /vd0 /GX /Zi /Od /I "." /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /I "..\..\Window\Inc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /Yu"WinDrvPrivate.h" /FD /Zm256 /c
...
# ADD LINK32 ..\..\Core\Lib\Core.lib ..\..\Engine\Lib\Engine.lib ..\Lib\ddraw.lib ..\Lib\dxguid.lib gdi32.lib kernel32.lib user32.lib winmm.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\System\WinDrv.dll" /pdbtype:sept
...
SOURCE=.\WinDrv.cpp
# ADD CPP /Yc"WinDrvPrivate.h"
# End Source File
# Begin Source File

SOURCE=.\WinDrvPrivate.h
# End Source File
# Begin Source File
