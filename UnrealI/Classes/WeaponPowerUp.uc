...
#exec OBJ LOAD FILE=Textures\fireeffect22.utx PACKAGE=UNREALI.Effect22
...
#exec MESHMAP SETTEXTURE MESHMAP=WeaponPowerUpMesh NUM=0 TEXTURE=Unreali.Effect22.FireEffect22
...
defaultproperties
{
     PowerUpSounds(0)=Sound'UnrealI.Dispersion.number1'
     PowerUpSounds(1)=Sound'UnrealI.Dispersion.number2'
     PowerUpSounds(2)=Sound'UnrealI.Dispersion.number3'
     PowerUpSounds(3)=Sound'UnrealI.Dispersion.number4'
     PickupMessage="You got the Dispersion Pistol Powerup"
     PickupViewMesh=Mesh'UnrealI.WeaponPowerUpMesh'
     AnimSequence=AnimEnergy
     Mesh=Mesh'UnrealI.WeaponPowerUpMesh'
     bMeshCurvy=False
