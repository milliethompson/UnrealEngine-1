...
#exec OBJ LOAD FILE=Textures\fireeffect8.utx  PACKAGE=UNREALI.Effect8
#exec MESHMAP SCALE MESHMAP=FlareM X=0.02 Y=0.02 Z=0.04
#exec MESHMAP SETTEXTURE MESHMAP=FlareM NUM=1 TEXTURE=JMisc1
#exec MESHMAP SETTEXTURE MESHMAP=FlareM NUM=0 TEXTURE=Unreali.Effect8.FireEffect8
...
defaultproperties
{
     ...
     PickupViewMesh=Mesh'UnrealI.FlareM'
     Charge=10
     PickupSound=Sound'UnrealI.Pickups.GenPickSnd'
     ActivateSound=Sound'UnrealI.Pickups.flares1'
     Icon=Texture'UnrealI.Icons.I_Flare'
     RemoteRole=ROLE_DumbProxy
     Mesh=Mesh'UnrealI.FlareM'
     bUnlit=True
     bMeshCurvy=False
