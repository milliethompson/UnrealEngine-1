...
#exec OBJ LOAD FILE=Textures\SmokeEffect1.utx PACKAGE=UNREALI.SEffect1
#exec MESHMAP SCALE MESHMAP=SmokePuffM X=0.03 Y=0.03 Z=0.06
#exec MESHMAP SETTEXTURE MESHMAP=SmokePuffM NUM=1 TEXTURE=Unreali.SEffect1.Smoke1
