...
defaultproperties
{
     ...
     FireSound=Sound'UnrealI.AutoMag.shot'
     AltFireSound=Sound'UnrealI.AutoMag.shot'
     CockingSound=Sound'UnrealI.AutoMag.Cocking'
     SelectSound=Sound'UnrealI.AutoMag.Cocking'
     Misc1Sound=Sound'UnrealI.flak.click'
     Misc2Sound=Sound'UnrealI.AutoMag.Reload'
     AutoSwitchPriority=2
     InventoryGroup=2
     PickupMessage="You got the AutoMag"
     PlayerViewOffset=(X=4.800000,Y=-1.700000,Z=-2.700000)
     PlayerViewMesh=Mesh'UnrealI.AutoMagL'
     PickupViewMesh=Mesh'UnrealI.AutoMagPickup'
     ThirdPersonMesh=Mesh'UnrealI.auto3rd'
     PickupSound=Sound'UnrealI.Pickups.WeaponPickup'
     Mesh=Mesh'UnrealI.AutoMagPickup'
     bNoSmooth=False
     bMeshCurvy=False
