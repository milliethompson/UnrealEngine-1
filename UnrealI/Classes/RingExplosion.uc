...
#exec OBJ LOAD FILE=Textures\fireeffect50.utx PACKAGE=UNREALI.Effect50
#exec MESHMAP SCALE MESHMAP=Ringex X=0.4 Y=0.4 Z=0.8 YAW=128
#exec MESHMAP SETTEXTURE MESHMAP=Ringex NUM=0 TEXTURE=Unreali.Effect50.FireEffect50
