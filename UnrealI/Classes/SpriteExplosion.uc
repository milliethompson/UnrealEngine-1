...
defaultproperties
{
     s_Exp(1)=UnrealI.s_Exp001
     s_Exp(2)=UnrealI.s_Exp002
     s_Exp(3)=UnrealI.s_Exp003
     s_Exp(4)=UnrealI.s_Exp004
     s_Exp(5)=UnrealI.s_Exp005
     s_Exp(6)=UnrealI.s_Exp006
     s_Exp(7)=UnrealI.s_Exp007
     s_Exp(8)=UnrealI.s_Exp008
     s_Exp(9)=UnrealI.s_Exp009
     s_Exp(10)=UnrealI.s_Exp010
     s_Exp(11)=UnrealI.s_Exp011
     s_Exp(12)=UnrealI.s_Exp012
     s_Exp(13)=UnrealI.s_Exp013
     s_Exp(14)=UnrealI.s_Exp014
     s_Exp(15)=UnrealI.s_Exp015
     s_Exp(16)=UnrealI.s_Exp016
     s_Exp(17)=UnrealI.s_Exp017
     s_Exp(18)=UnrealI.s_Exp018
     s_Exp(19)=UnrealI.s_Exp019
     DrawType=DT_Sprite
     Texture=UnrealI.s_Exp001
     AmbientGlow=160
     Physics=PHYS_None
