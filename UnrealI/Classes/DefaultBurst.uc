...
#exec OBJ LOAD FILE=textures\dtexpl.utx PACKAGE=UNREALI.DEFBurst
...
defaultproperties
{
     EffectSound1=Sound'UnrealI.General.Exple03'
     RemoteRole=ROLE_SimulatedProxy
     LifeSpan=0.400000
     DrawType=DT_SpriteAnimOnce
     Style=STY_Translucent
     Texture=Texture'UnrealI.DEFBurst.dt_a00'
     Skin=Texture'UnrealI.Effects.ExplosionPal'
     DrawScale=1.500000
