...
#exec OBJ LOAD FILE=textures\SkaarjP.utx PACKAGE=UNREALI.SKEffect
...
defaultproperties
{
     ...
     Damage=+00016.000000
     SpawnSound=UnrealI.Skrjshot
     ImpactSound=UnrealI.SkrjImp
     DrawType=DT_Sprite
     Style=STY_Translucent
     Texture=UnrealI.SKEffect.Skj_a00
