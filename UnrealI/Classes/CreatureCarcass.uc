...
defaultproperties
{
     bodyparts(0)=Mesh'UnrealI.CowBody1'
     bodyparts(1)=Mesh'UnrealI.CowBody1'
     bodyparts(2)=Mesh'UnrealI.CowBody2'
     bodyparts(3)=Mesh'UnrealI.CowBody2'
     bodyparts(4)=Mesh'UnrealI.LiverM'
     bodyparts(5)=Mesh'UnrealI.LiverM'
     Trails(0)=0.500000
     Trails(1)=0.500000
     Trails(2)=0.500000
     Trails(3)=0.500000
     ...
     ZOffset(0)=0.500000
     ZOffset(1)=-0.500000
     GibOne=Sound'UnrealI.Gibs.Gib1'
     GibTwo=Sound'UnrealI.Gibs.Gib2'
     LandedSound=Sound'UnrealI.Gibs.Thump'
