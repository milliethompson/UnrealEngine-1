...
defaultproperties
{
     SpriteAnim(0)=Texture'UnrealI.Maineffect.e1_a00'
     SpriteAnim(1)=Texture'UnrealI.Maineffect.e2_a00'
     SpriteAnim(2)=Texture'UnrealI.Maineffect.e3_a00'
     SpriteAnim(3)=Texture'UnrealI.Maineffect.e4_a00'
     SpriteAnim(4)=Texture'UnrealI.Maineffect.e5_a00'
     NumFrames=8
     Pause=0.050000
     EffectSound1=Sound'UnrealI.Explo1'
     DrawType=DT_SpriteAnimOnce
     Style=STY_Translucent
     Texture=Texture'UnrealI.Maineffect.e1_a00'
     Skin=Texture'UnrealI.ExplosionPal'
     DrawScale=3.500000
     bMeshCurvy=False
