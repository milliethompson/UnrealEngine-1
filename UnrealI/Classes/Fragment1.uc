...
defaultproperties
{
     Fragments(0)=UnrealI.vfrag1
     Fragments(1)=UnrealI.vfrag2
     Fragments(2)=UnrealI.vfrag3
     Fragments(3)=UnrealI.vfrag4
     Fragments(4)=UnrealI.vfrag5
     Fragments(5)=UnrealI.vfrag6
     Fragments(6)=UnrealI.vfrag7
     numFragmentTypes=7
     ImpactSound=UnrealI.GlassTink1
     MiscSound=UnrealI.GlassTink2
     Mesh=UnrealI.vfrag1
