...
#exec OBJ LOAD FILE=Textures\WaterEffect1.utx  PACKAGE=UNREALI.WEffect1
...
#exec  MESHMAP SETTEXTURE MESHMAP=SuperHealthMesh NUM=0 TEXTURE=Unreali.WEffect1.WaterEffect1
...
defaultproperties
{
     ...
     PickupViewMesh=UnrealI.SuperHealthMesh
     Texture=None
     Mesh=UnrealI.SuperHealthMesh
