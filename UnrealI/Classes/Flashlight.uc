...
defaultproperties
{
     ...
     PickupViewMesh=Mesh'UnrealI.Flashl'
     Charge=800
     PickupSound=Sound'UnrealI.Pickups.GenPickSnd'
     ActivateSound=Sound'UnrealI.Pickups.FSHLITE1'
     DeActivateSound=Sound'UnrealI.Pickups.FSHLITE2'
     Icon=Texture'UnrealI.Icons.I_Flashlight'
     RemoteRole=ROLE_DumbProxy
     Mesh=Mesh'UnrealI.Flashl'
     AmbientGlow=96
     bMeshCurvy=False
