...
#exec MESHMAP SETTEXTURE MESHMAP=StingerM NUM=0 TEXTURE=Unreali.Effect18.FireEffect18
...
#exec MESHMAP SETTEXTURE MESHMAP=Stinger3rd NUM=0 TEXTURE=Unreali.Effect18.FireEffect18
...
defaultproperties
{
     AmmoName=Class'UnrealI.StingerAmmo'
     PickupAmmoCount=40
     bAltWarnTarget=True
     ...
     AIRating=0.400000
     RefireRate=0.800000
     FireSound=Sound'UnrealI.Stinger.StingerFire'
     AltFireSound=Sound'UnrealI.Stinger.StingerAltFire'
     SelectSound=Sound'UnrealI.Stinger.StingerLoad'
     Misc1Sound=Sound'UnrealI.Stinger.EndFire'
     AutoSwitchPriority=3
     InventoryGroup=3
     PickupMessage="You picked up the Stinger"
     PlayerViewOffset=(X=4.200000,Y=-3.000000,Z=-4.000000)
     PlayerViewMesh=Mesh'UnrealI.StingerM'
     PlayerViewScale=1.700000
     PickupViewMesh=Mesh'UnrealI.StingerPickup'
     ThirdPersonMesh=Mesh'UnrealI.Stinger3rd'
     PickupSound=Sound'UnrealI.Pickups.WeaponPickup'
     Mesh=Mesh'UnrealI.StingerPickup'
     bNoSmooth=False
     bMeshCurvy=False
     SoundRadius=64
     SoundVolume=255
