...
defaultproperties
{
     Fragments(0)=UnrealI.wfrag1
     Fragments(1)=UnrealI.wfrag2
     Fragments(2)=UnrealI.wfrag3
     Fragments(3)=UnrealI.wfrag4
     Fragments(4)=UnrealI.wfrag5
     Fragments(5)=UnrealI.wfrag6
     Fragments(6)=UnrealI.wfrag7
     Fragments(7)=UnrealI.wfrag8
     Fragments(8)=UnrealI.wfrag9
     numFragmentTypes=9
     ImpactSound=UnrealI.WoodHit1
     MiscSound=UnrealI.WoodHit2
     Mesh=UnrealI.wfrag2
