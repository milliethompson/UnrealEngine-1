...
#exec MESHMAP SETTEXTURE MESHMAP=DispM1 NUM=0 TEXTURE=Unreali.Effect1.FireEffect1e
#exec MESHMAP SETTEXTURE MESHMAP=DispM1 NUM=1 TEXTURE=Unreali.Effect1.FireEffect1d

defaultproperties
{
     ParticleType=Class'UnrealI.Spark32'
     SparkModifier=1.500000
     ExpType=Class'UnrealI.SpriteYellowE'
     Damage=25.000000
     Mesh=Mesh'UnrealI.DispM1'
     LightBrightness=155
     LightHue=42
     LightSaturation=72
}
