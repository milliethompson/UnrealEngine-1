...
#exec MESHMAP SETTEXTURE MESHMAP=Brute1 NUM=1 TEXTURE=UNREALI.Effect18.FireEffect18
...
defaultproperties
{
     ...
     WhipDamage=20
     footstep=UnrealI.walk1br
     Footstep2=UnrealI.walk2br
     PistolWhip=UnrealI.pwhip1br
     PistolHit=UnrealI.pstlhit1br
     Die2=UnrealI.death2br
     CarcassType=UnrealI.BruteCarcass
     ...
     bLeadTarget=False
     RangedProjectile=UnrealI.BruteProjectile
     ProjectileSpeed=+00700.000000
     Acquire=UnrealI.yell1br
     Fear=UnrealI.injur2br
     Roam=UnrealI.nearby2br
     Threaten=UnrealI.yell2br
     Health=340
     ...
     JumpZ=-00001.000000
     HitSound1=UnrealI.injur1br
     HitSound2=UnrealI.injur2br
     Land=None
     Die=UnrealI.death1br
     WaterStep=None
     CombatStyle=+00000.800000
     DrawType=DT_Mesh
     Mesh=UnrealI.Brute1
     bMeshCurvy=False
     AmbientSound=UnrealI.amb1br
