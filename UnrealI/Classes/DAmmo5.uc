...
#exec MESHMAP SETTEXTURE MESHMAP=DispM4 NUM=0 TEXTURE=Unreali.Effect1.FireEffect1p
#exec MESHMAP SETTEXTURE MESHMAP=DispM4 NUM=1 TEXTURE=Unreali.Effect1.FireEffect1ob

defaultproperties
{
     ParticleType=Class'UnrealI.Spark35'
     SparkModifier=3.000000
     ExpType=Class'UnrealI.SpriteRedE'
     Damage=75.000000
     Mesh=Mesh'UnrealI.DispM4'
     LightBrightness=190
     LightHue=5
     LightSaturation=63
}
