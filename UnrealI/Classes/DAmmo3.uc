...
#exec MESHMAP SETTEXTURE MESHMAP=DispM2 NUM=0 TEXTURE=Unreali.Effect1.FireEffect1a
#exec MESHMAP SETTEXTURE MESHMAP=DispM2 NUM=1 TEXTURE=Unreali.Effect1.FireEffect1

defaultproperties
{
     ParticleType=Class'UnrealI.Spark33'
     SparkModifier=2.000000
     ExpType=Class'UnrealI.SpriteGreenE'
     Damage=40.000000
     Mesh=Mesh'UnrealI.DispM2'
     LightBrightness=150
     LightHue=83
     LightSaturation=50
}
