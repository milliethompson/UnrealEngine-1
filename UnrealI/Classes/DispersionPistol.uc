...
#exec MESHMAP SETTEXTURE MESHMAP=DPistol NUM=0  TEXTURE=Unreali.SEffect2.SmokeEffect2
...
defaultproperties
{
     AmmoName=Class'UnrealI.DefaultAmmo'
     PickupAmmoCount=50
     bAltWarnTarget=True
     ...
     FireSound=Sound'UnrealI.Dispersion.DispShot'
     AltFireSound=Sound'UnrealI.Dispersion.DispShot'
     SelectSound=Sound'UnrealI.Dispersion.DispPickup'
     Misc1Sound=Sound'UnrealI.Dispersion.PowerUp3'
     PickupMessage="You got the Dispersion Pistol"
     PlayerViewOffset=(X=3.800000,Y=-2.000000,Z=-2.000000)
     PlayerViewMesh=Mesh'UnrealI.DPistol'
     PickupViewMesh=Mesh'UnrealI.DPistolPick'
     ThirdPersonMesh=Mesh'UnrealI.DPistol3rd'
     PickupSound=Sound'UnrealI.Pickups.WeaponPickup'
     Texture=None
     Mesh=Mesh'UnrealI.DPistolPick'
     bNoSmooth=False
     bMeshCurvy=False
