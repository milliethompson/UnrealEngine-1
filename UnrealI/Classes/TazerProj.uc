...
#exec OBJ LOAD FILE=Textures\FireEffect2.utx PACKAGE=UNREALI.Effect2
#exec MESHMAP SETTEXTURE MESHMAP=TazerProja NUM=1 TEXTURE=Unreali.Effect2.FireEffect2
...
defaultproperties
{
     ...
     ImpactSound=Sound'UnrealI.General.Expla02'
     RemoteRole=ROLE_SimulatedProxy
     LifeSpan=10.000000
     Mesh=Mesh'UnrealI.TazerProja'
     bUnlit=True
     bMeshCurvy=False
