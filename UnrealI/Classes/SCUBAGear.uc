...
defaultproperties
{
     ...
     PickupViewMesh=Mesh'UnrealI.Scuba'
     Charge=1200
     PickupSound=Sound'UnrealI.Pickups.GenPickSnd'
     ActivateSound=Sound'UnrealI.Pickups.Scubal1'
     DeActivateSound=Sound'UnrealI.Pickups.Scubada1'
     RespawnSound=Sound'UnrealI.Pickups.Scubal2'
     Icon=Texture'UnrealI.Icons.I_Scuba'
     RemoteRole=ROLE_DumbProxy
     Mesh=Mesh'UnrealI.Scuba'
     bMeshCurvy=False
