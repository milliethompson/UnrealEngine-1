...
function SetUpDisplay()
{
	...
	for ( i=0; i<NumPlayerClasses; i++ )
		if ( PlayerClasses[i] ~= ("Unreali."$PlayerOwner.Class) )
		{
			PlayerClassNum = i;
			break;
		}
...
defaultproperties
{
	...
	PlayerClasses(0)="Unreali.FemaleOne"
	PlayerClasses(1)="Unreali.FemaleTwo"
	PlayerClasses(2)="Unreali.MaleOne"
	PlayerClasses(3)="Unreali.MaleTwo"
	PlayerClasses(4)="Unreali.MaleThree"
	PlayerClasses(5)="Unreali.SkaarjPlayer"
	PlayerClasses(6)="Unreali.UnrealSpectator"
