...
#exec OBJ LOAD FILE=textures\cflame.utx PACKAGE=UNREALI.CFLAM
#exec MESHMAP SCALE MESHMAP=candleM X=0.03 Y=0.03 Z=0.06
#exec MESHMAP SETTEXTURE MESHMAP=candleM NUM=1 TEXTURE=Jcandle1
#exec MESHMAP SETTEXTURE MESHMAP=candleM NUM=0 TEXTURE=Unreali.CFLAM.cflame

defaultproperties
{
     DrawType=DT_Mesh
     Mesh=Mesh'UnrealI.CandleM'
     bMeshCurvy=False
