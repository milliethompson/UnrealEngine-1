...
#exec OBJ LOAD FILE=Textures\fireeffect5.utx PACKAGE=UNREALI.Effect5
#exec MESHMAP SCALE MESHMAP=FatRingM X=0.5 Y=0.5 Z=1.0 
#exec MESHMAP SETTEXTURE MESHMAP=FatRingM NUM=1 TEXTURE=Unreali.Effect5.FireEffect5
...
defaultproperties
{
     EffectSound1=UnrealI.FatRingSound
     DrawType=DT_Mesh
     Mesh=UnrealI.FatRingM
     AmbientGlow=97
     bMeshCurvy=False
     LightType=LT_Steady
     LightBrightness=255
