...
#exec OBJ LOAD FILE=Textures\fireeffect25.utx PACKAGE=UNREALI.Effect25
#exec MESHMAP SCALE MESHMAP=WireM X=0.13 Y=0.13 Z=0.26
#exec MESHMAP SETTEXTURE MESHMAP=WireM NUM=1 TEXTURE=JWire1
#exec MESHMAP SETTEXTURE MESHMAP=WireM NUM=0 TEXTURE=Unreali.Effect25.FireEffect25
