...
defaultproperties
{
     bodyparts(0)=UnrealI.BruteHead
     bodyparts(1)=UnrealI.BruteFoot
     bodyparts(2)=UnrealI.BruteHand
     bodyparts(3)=UnrealI.BigChunk1
     bodyparts(4)=UnrealI.BrutePiece
     bodyparts(5)=UnrealI.BrutePiece
     bodyparts(6)=UnrealI.BruteHand
