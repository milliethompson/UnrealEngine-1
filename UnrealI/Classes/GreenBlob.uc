...
defaultproperties
{
     BlobTypes(0)=Texture'UnrealI.Effects.GreenBlob1'
     BlobTypes(1)=Texture'UnrealI.Effects.GreenBlob2'
     BlobTypes(2)=Texture'UnrealI.Effects.GreenBlob3'
     BlobTypes(3)=Texture'UnrealI.Effects.GreenBlob4'
     BlobTypes(4)=Texture'UnrealI.Effects.GreenBlob5'
     Physics=PHYS_Falling
     RemoteRole=ROLE_SimulatedProxy
     LifeSpan=7.000000
     DrawType=DT_Sprite
     Style=STY_Translucent
     Texture=Texture'UnrealI.Effects.GreenBlob1'
     bUnlit=True
     bMeshCurvy=False
