...
defaultproperties
{
     ...
     AmpSound=Sound'UnrealI.Pickups.AmpAct'
     bCanActivate=True
     ...
     PickupViewMesh=Mesh'UnrealI.AmplifierM'
     Charge=1000
     MaxDesireability=1.200000
     PickupSound=Sound'UnrealI.Pickups.GenPickSnd'
     ActivateSound=Sound'UnrealI.Pickups.HEALTH1'
     Icon=Texture'UnrealI.Icons.I_Amp'
     Mesh=Mesh'UnrealI.AmplifierM'
     bMeshCurvy=False
