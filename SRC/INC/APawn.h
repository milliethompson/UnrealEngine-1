...
public:
	...
	int findPathTo(FVector Dest, FLOAT maxweight, AActor *&bestPath);
	int findPathToward(AActor *goal, FLOAT maxweight, AActor *&bestPath);
	int bestPathFrom(AActor *startnode, float &bestweight, float currentweight, AActor *&bestPath);
	void clearPaths();
//};
