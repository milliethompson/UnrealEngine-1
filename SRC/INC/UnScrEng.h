/*=============================================================================
	UnScrEng.h: UnrealScript engine
...
#ifndef _INC_UNSCRENG
#define _INC_UNSCRENG
...
//
// One permanent FScriptExecutionThread is stored in AActor and is permanently tracked 
...
class UNREAL_API FScriptCompiler // Script compiler global variables
	...
	char inline		GetChar			();
	char inline		GetLeadingChar	();
	void inline		UngetChar		();
	void inline		SkipBlanks		();
